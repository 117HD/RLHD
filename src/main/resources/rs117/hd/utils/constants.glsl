...
#define SHADOW_DEPTH_BITS 12
#define SHADOW_ALPHA_BITS 4
...
#include SHADOW_SHADING
#define SHADOW_BASE_SHADING 0
#define SHADOW_DITHERED_SHADING 1
#define SHADOW_PIXELATED_SHADING 2

#include SHADOW_TRANSPARENCY
#define SHADOW_TRANSPARENCY_DISABLED 0
#define SHADOW_TRANSPARENCY_ENABLED 1
#define SHADOW_TRANSPARENCY_ENABLED_WITH_TINT 2

#include SHADOW_CONSTANT_BIAS
#include SHADOW_SLOPE_BIAS
#include GROUND_SHADOWS
#if SHADOW_TRANSPARENCY != SHADOW_TRANSPARENCY_DISABLED
