...
public class Constants {
    ...
    public static File PACK_DIR_ROOT = new File(RuneLite.RUNELITE_DIR, "117-resource-packs");
    public static File PACK_DIR = new File(PACK_DIR_ROOT, "normal");
    public static File DEV_PACK_DIR = new File(PACK_DIR_ROOT, "development");
