...
public enum GLTextureFormat {
	...
	RGBA32UI(GL_RGBA32I, GL_RGBA_INTEGER, GL_UNSIGNED_INT, 16, 32, 32, 32, 32),
	...
	R16UI(GL_R16I, GL_RED_INTEGER, GL_UNSIGNED_SHORT, 2, 16, 0, 0, 0),
	R32F(GL_R32F, GL_RED, GL_FLOAT, 4, 32, 0, 0, 0),
	R32I(GL_R32I, GL_RED_INTEGER, GL_INT, 4, 32, 0, 0, 0),
	R32UI(GL_R32I, GL_RED_INTEGER, GL_UNSIGNED_INT, 4, 32, 0, 0, 0),

	BGRA8(GL_BGRA, GL_BGRA, GL_UNSIGNED_INT_8_8_8_8_REV, 4, 8, 8, 8, 8),
