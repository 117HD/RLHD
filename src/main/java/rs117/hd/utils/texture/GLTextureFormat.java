...
public enum GLTextureFormat {
	...
	RGBA16UI(GL_RGBA16UI, GL_RGBA_INTEGER, GL_UNSIGNED_SHORT, 8, 16, 16, 16, 16),
	RGBA16I(GL_RGBA16I, GL_RGBA_INTEGER, GL_SHORT, 8, 16, 16, 16, 16),
	RGBA32F(GL_RGBA32F, GL_RGBA, GL_FLOAT, 16, 32, 32, 32, 32),
	RGBA32UI(GL_RGBA32UI, GL_RGBA_INTEGER, GL_UNSIGNED_INT, 16, 32, 32, 32, 32),
	...
	R16UI(GL_R16UI, GL_RED_INTEGER, GL_UNSIGNED_SHORT, 2, 16, 0, 0, 0),
	R32F(GL_R32F, GL_RED, GL_FLOAT, 4, 32, 0, 0, 0),
	R32I(GL_R32I, GL_RED_INTEGER, GL_INT, 4, 32, 0, 0, 0),
	R32UI(GL_R32UI, GL_RED_INTEGER, GL_UNSIGNED_INT, 4, 32, 0, 0, 0),

	BGRA8(GL_BGRA, GL_BGRA, GL_UNSIGNED_BYTE, 4, 8, 8, 8, 8),
	BGRA_INT_8_8_8_8(GL_BGRA, GL_BGRA, GL_UNSIGNED_INT_8_8_8_8_REV, 4, 8, 8, 8, 8),
	...
	public int bytesPerPixel() {
		return (redSize + greenSize + blueSize + alphaSize) / 8;
	}
