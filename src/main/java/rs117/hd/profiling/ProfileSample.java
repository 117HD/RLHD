...
public class ProfileSample {
	...
	public ProfileSample(long frameTimestamp, long totalAsyncTime, long[] stats, Event[] events, int eventCount, float cpuLoad, long heapUsageKB, long freeSystemMemoryKB, long gpuUsageKB) {
