...
public class NewGroundMaterial {
	...
	public static final NewGroundMaterial DIRT = new NewGroundMaterial("DIRT", Material.DIRT_1, Material.DIRT_2);
	public static final NewGroundMaterial UNDERWATER_GENERIC = new NewGroundMaterial(
		"UNDERWATER_GENERIC",
		Material.DIRT_1,
		Material.DIRT_2
	);
	...
	@Slf4j
	public static class JsonAdapter extends TypeAdapter<NewGroundMaterial> {
		@Override
		public NewGroundMaterial read(JsonReader in) throws IOException {
		...
		@Override
		public void write(JsonWriter out, NewGroundMaterial groundMaterial) throws IOException {
