...
public class UBOMaterials extends UniformBuffer<GLBuffer> {
	public static class MaterialStruct extends StructProperty {
		...
		public Property hexTilingScale = addProperty(PropertyType.Float, "hexTilingScale"); // TODO: combine with textureScale if sensible
		public Property hexTilingBlend = addProperty(PropertyType.Float, "hexTilingBlend"); //       & reuse unused textureScale component
