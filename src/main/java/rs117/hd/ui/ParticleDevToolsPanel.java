...
public class ParticleDevToolsPanel extends PluginPanel {
	...
	private void showEditorFor(ParticleDefinition def) {
		...
		targetSpeedSpinner.setValue(def.targetSpeed >= 0f ? def.targetSpeed : -1);
	...
	private void applyAllToDefinition() {
		...
		def.spreadYawMin = ((Number) spreadYawMinSpinner.getValue()).floatValue();
		def.spreadYawMax = ((Number) spreadYawMaxSpinner.getValue()).floatValue();
		def.spreadPitchMin = ((Number) spreadPitchMinSpinner.getValue()).floatValue();
		def.spreadPitchMax = ((Number) spreadPitchMaxSpinner.getValue()).floatValue();
		...
		def.targetScale = ((Number) targetScaleSpinner.getValue()).floatValue();
